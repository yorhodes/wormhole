module wormhole::structs {
    ...
    public(friend) fun expire_guardian_set(guardian_set: &mut GuardianSet, delta: u64, ctx: &TxContext) {
        guardian_set.expiration_time = tx_context::epoch(ctx) + delta;
    }
    ...
    public fun get_guardian_set_expiry(guardian_set: &GuardianSet): u64 {
