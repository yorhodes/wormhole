...
func runNode(cmd *cobra.Command, args []string) {
	...
	supervisor.New(rootCtx, logger, func(ctx context.Context) error {
		...
		if shouldStart(ethRPC) {
			...
			ethWatcher = evm.NewEthWatcher(*ethRPC, ethContractAddr, "eth", common.ReadinessEthSyncing, vaa.ChainIDEthereum, chainMsgC[vaa.ChainIDEthereum], setC, chainObsvReqC[vaa.ChainIDEthereum], *unsafeDevMode)
		...
		if shouldStart(avalancheRPC) {
			...
			if err := supervisor.Run(ctx, "avalanchewatch",
				evm.NewEthWatcher(*avalancheRPC, avalancheContractAddr, "avalanche", common.ReadinessAvalancheSyncing, vaa.ChainIDAvalanche, chainMsgC[vaa.ChainIDAvalanche], nil, chainObsvReqC[vaa.ChainIDAvalanche], *unsafeDevMode).Run); err != nil {
				return err
			}
		}
		if shouldStart(oasisRPC) {
			...
			if err := supervisor.Run(ctx, "oasiswatch",
				evm.NewEthWatcher(*oasisRPC, oasisContractAddr, "oasis", common.ReadinessOasisSyncing, vaa.ChainIDOasis, chainMsgC[vaa.ChainIDOasis], nil, chainObsvReqC[vaa.ChainIDOasis], *unsafeDevMode).Run); err != nil {
				return err
			}
		}
		if shouldStart(auroraRPC) {
			...
			if err := supervisor.Run(ctx, "aurorawatch",
				evm.NewEthWatcher(*auroraRPC, auroraContractAddr, "aurora", common.ReadinessAuroraSyncing, vaa.ChainIDAurora, chainMsgC[vaa.ChainIDAurora], nil, chainObsvReqC[vaa.ChainIDAurora], *unsafeDevMode).Run); err != nil {
				return err
			}
		}
		if shouldStart(fantomRPC) {
			...
			if err := supervisor.Run(ctx, "fantomwatch",
				evm.NewEthWatcher(*fantomRPC, fantomContractAddr, "fantom", common.ReadinessFantomSyncing, vaa.ChainIDFantom, chainMsgC[vaa.ChainIDFantom], nil, chainObsvReqC[vaa.ChainIDFantom], *unsafeDevMode).Run); err != nil {
				return err
			}
		}
		if shouldStart(karuraRPC) {
			...
			if err := supervisor.Run(ctx, "karurawatch",
				evm.NewEthWatcher(*karuraRPC, karuraContractAddr, "karura", common.ReadinessKaruraSyncing, vaa.ChainIDKarura, chainMsgC[vaa.ChainIDKarura], nil, chainObsvReqC[vaa.ChainIDKarura], *unsafeDevMode).Run); err != nil {
				return err
			}
		}
		if shouldStart(acalaRPC) {
			...
			if err := supervisor.Run(ctx, "acalawatch",
				evm.NewEthWatcher(*acalaRPC, acalaContractAddr, "acala", common.ReadinessAcalaSyncing, vaa.ChainIDAcala, chainMsgC[vaa.ChainIDAcala], nil, chainObsvReqC[vaa.ChainIDAcala], *unsafeDevMode).Run); err != nil {
				return err
			}
		}
		if shouldStart(klaytnRPC) {
			...
			if err := supervisor.Run(ctx, "klaytnwatch",
				evm.NewEthWatcher(*klaytnRPC, klaytnContractAddr, "klaytn", common.ReadinessKlaytnSyncing, vaa.ChainIDKlaytn, chainMsgC[vaa.ChainIDKlaytn], nil, chainObsvReqC[vaa.ChainIDKlaytn], *unsafeDevMode).Run); err != nil {
				return err
			}
		}
		if shouldStart(celoRPC) {
			...
			if err := supervisor.Run(ctx, "celowatch",
				evm.NewEthWatcher(*celoRPC, celoContractAddr, "celo", common.ReadinessCeloSyncing, vaa.ChainIDCelo, chainMsgC[vaa.ChainIDCelo], nil, chainObsvReqC[vaa.ChainIDCelo], *unsafeDevMode).Run); err != nil {
				return err
			}
		}
		if shouldStart(moonbeamRPC) {
			...
			if err := supervisor.Run(ctx, "moonbeamwatch",
				evm.NewEthWatcher(*moonbeamRPC, moonbeamContractAddr, "moonbeam", common.ReadinessMoonbeamSyncing, vaa.ChainIDMoonbeam, chainMsgC[vaa.ChainIDMoonbeam], nil, chainObsvReqC[vaa.ChainIDMoonbeam], *unsafeDevMode).Run); err != nil {
				return err
			}
		}
		...
		if shouldStart(terraWS) {
			...
			if err := supervisor.Run(ctx, "terrawatch",
				cosmwasm.NewWatcher(*terraWS, *terraLCD, *terraContract, chainMsgC[vaa.ChainIDTerra], chainObsvReqC[vaa.ChainIDTerra], common.ReadinessTerraSyncing, vaa.ChainIDTerra).Run); err != nil {
				return err
			}
		}
		...
		if shouldStart(terra2WS) {
			...
			if err := supervisor.Run(ctx, "terra2watch",
				cosmwasm.NewWatcher(*terra2WS, *terra2LCD, *terra2Contract, chainMsgC[vaa.ChainIDTerra2], chainObsvReqC[vaa.ChainIDTerra2], common.ReadinessTerra2Syncing, vaa.ChainIDTerra2).Run); err != nil {
				return err
			}
		}
		...
		if shouldStart(xplaWS) {
			...
			if err := supervisor.Run(ctx, "xplawatch",
				cosmwasm.NewWatcher(*xplaWS, *xplaLCD, *xplaContract, chainMsgC[vaa.ChainIDXpla], chainObsvReqC[vaa.ChainIDXpla], common.ReadinessXplaSyncing, vaa.ChainIDXpla).Run); err != nil {
				return err
			}
		}
		...
		if shouldStart(algorandIndexerRPC) {
			...
			if err := supervisor.Run(ctx, "algorandwatch",
				algorand.NewWatcher(*algorandIndexerRPC, *algorandIndexerToken, *algorandAlgodRPC, *algorandAlgodToken, *algorandAppID, chainMsgC[vaa.ChainIDAlgorand], chainObsvReqC[vaa.ChainIDAlgorand]).Run); err != nil {
				return err
			}
		}
		if shouldStart(nearRPC) {
			...
			if err := supervisor.Run(ctx, "nearwatch",
				near.NewWatcher(*nearRPC, *nearContract, chainMsgC[vaa.ChainIDNear], chainObsvReqC[vaa.ChainIDNear], !(*unsafeDevMode || *testnetMode)).Run); err != nil {
				return err
			}
		}
		...
		if shouldStart(solanaRPC) {
			...
			if err := supervisor.Run(ctx, "solwatch-confirmed",
				solana.NewSolanaWatcher(*solanaRPC, solAddress, chainMsgC[vaa.ChainIDSolana], nil, rpc.CommitmentConfirmed, common.ReadinessSolanaSyncing, vaa.ChainIDSolana).Run); err != nil {
				return err
			}
			solanaFinalizedWatcher = solana.NewSolanaWatcher(*solanaRPC, solAddress, chainMsgC[vaa.ChainIDSolana], chainObsvReqC[vaa.ChainIDSolana], rpc.CommitmentFinalized, common.ReadinessSolanaSyncing, vaa.ChainIDSolana)
		...
		if shouldStart(pythnetRPC) {
			...
			if err := supervisor.Run(ctx, "pythwatch-confirmed",
				solana.NewSolanaWatcher(*pythnetRPC, pythnetAddress, chainMsgC[vaa.ChainIDPythNet], nil, rpc.CommitmentConfirmed, common.ReadinessPythNetSyncing, vaa.ChainIDPythNet).Run); err != nil {
				return err
			}
			if err := supervisor.Run(ctx, "pythwatch-finalized",
				solana.NewSolanaWatcher(*pythnetRPC, pythnetAddress, chainMsgC[vaa.ChainIDPythNet], chainObsvReqC[vaa.ChainIDPythNet], rpc.CommitmentFinalized, common.ReadinessPythNetSyncing, vaa.ChainIDPythNet).Run); err != nil {
				return err
			}
		}
		...
		if *testnetMode {
			...
			if shouldStart(injectiveWS) {
				...
				if err := supervisor.Run(ctx, "injectivewatch",
					cosmwasm.NewWatcher(*injectiveWS, *injectiveLCD, *injectiveContract, chainMsgC[vaa.ChainIDInjective], chainObsvReqC[vaa.ChainIDInjective], common.ReadinessInjectiveSyncing, vaa.ChainIDInjective).Run); err != nil {
					return err
				}
			}
		}
