...
var file_node_v1_node_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0x8c, 0x07, 0x0a, 0x15, 0x4e, 0x6f, 0x64, 0x65, 0x50, 0x72,
...
var file_node_v1_node_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
var file_node_v1_node_proto_goTypes = []interface{}{
	...
	(*GuardianSetUpdate_Guardian)(nil),             // 22: node.v1.GuardianSetUpdate.Guardian
	(*v1.ObservationRequest)(nil),                  // 23: gossip.v1.ObservationRequest
}
var file_node_v1_node_proto_depIdxs = []int32{
	...
	22, // 5: node.v1.GuardianSetUpdate.guardians:type_name -> node.v1.GuardianSetUpdate.Guardian
	23, // 6: node.v1.SendObservationRequestRequest.observation_request:type_name -> gossip.v1.ObservationRequest
	...
	9,  // 16: node.v1.NodePrivilegedService.FindMissingMessages:output_type -> node.v1.FindMissingMessagesResponse
	11, // 17: node.v1.NodePrivilegedService.SendObservationRequest:output_type -> node.v1.SendObservationRequestResponse
	13, // 18: node.v1.NodePrivilegedService.ChainGovernorStatus:output_type -> node.v1.ChainGovernorStatusResponse
	15, // 19: node.v1.NodePrivilegedService.ChainGovernorReload:output_type -> node.v1.ChainGovernorReloadResponse
	17, // 20: node.v1.NodePrivilegedService.ChainGovernorDropPendingVAA:output_type -> node.v1.ChainGovernorDropPendingVAAResponse
	19, // 21: node.v1.NodePrivilegedService.ChainGovernorReleasePendingVAA:output_type -> node.v1.ChainGovernorReleasePendingVAAResponse
	21, // 22: node.v1.NodePrivilegedService.ChainGovernorResetReleaseTimer:output_type -> node.v1.ChainGovernorResetReleaseTimerResponse
